  ...
  const handleExport = () => {
    ...
    target.innerHTML = `
      <div>
        <div class="print-header">
          <div class="print-project-name">Project God's Eye — Dover Strait Edition</div>
        ...
        <div class="print-footer">
          <span>Generated by GOD'S EYE ANALYST</span>
          <span>Exported: ${new Date().toUTCString()}</span>
        </div>
      </div>
    `;

    // Show on-screen preview first
    target.classList.add('on-screen-preview');
    ...
    setTimeout(async () => {
      try {
        ...
        const opt = {
          margin:       10,
          filename:     `GodsEye_SITREP_${incident.entity_id}.pdf`,
        ...
        // Remove preview once the download is initiated
        setTimeout(() => {
          target.classList.remove('on-screen-preview');
          target.innerHTML = '';
        }, 500);
      }
    }, 800);
      ...
      <div className="flex flex-col gap-2">
        {!isSitrepGenerated && (
          ...
          >
            ...
            {generating ? "GOD'S EYE ANALYST WORKING..." : "GENERATE AI SITREP"}
          </button>
        )}
